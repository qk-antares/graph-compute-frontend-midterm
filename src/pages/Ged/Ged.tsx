...
import Uploader from "@/pages/Ged/Uploader";
import Result from "@/pages/Ged/Result";
...
const Ged: React.FC = ()=>{
  ...
  return (<Row>
    ...
    <Col span={16} style={{paddingLeft: 4}}>
      <Card title='图编辑路径计算' bodyStyle={{display: 'flex', flexDirection: 'column', height: 'calc(100vh - 125px)', overflow: 'auto'}} style={{height: 'calc(100vh - 73px)', borderRadius: 4}}>
